...
class StandardRelayerApp extends application_1.RelayerApp {
    constructor(env, opts) {
        (0, utils_1.mergeDeep)(opts, defaultOpts);
        opts.logger = opts.logger || logging_1.defaultLogger;
        const { logger, privateKeys, name, spyEndpoint, redis, redisCluster } = opts;
        super(env, opts);
        ...
        this.use((0, missedVaas_middleware_1.missedVaas)(this, { namespace: name, logger, redis, redisCluster }));
        ...
        if (opts.privateKeys && Object.keys(opts.privateKeys).length) {
            ...
            this.use((0, wallet_middleware_1.wallets)({ logger, namespace: name, privateKeys }));
        }
        this.use((0, tokenBridge_middleware_1.tokenBridgeContracts)());
        this.use((0, staging_area_middleware_1.stagingArea)({ namespace: name, redisCluster, redis }));
    }
}
exports.StandardRelayerApp = StandardRelayerApp;
//# sourceMappingURL=standard-relayer.js.map